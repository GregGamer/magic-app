<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('archives.index') }}" :active="request()->routeIs('archives.index')">
                {{ __('Archives') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('decks.index') }}" :active="request()->routeIs('decks.index')">
                {{ __('Decks') }}
            </x-jet-responsive-nav-link>
        </div>
