<div class="" style="margin: 10px">
    <div class="md:grid md:grid-cols-3 md:gap-6">
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
            <form action="{{route('archives.update', ['archive' => $archive])}}" method="POST">
                @method('PATCH')
                @csrf
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="name" id="name" autocomplete="{{old('name')}}" value="{{ $archive->name ?? '' }}"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="short_description" id="short_description"
                                       autocomplete="{{old('short_description')}}" value="{{ $archive->short_description ?? '' }}"
                                       class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <input type="text" name="description" id="description"
                                       autocomplete="{{old('description')}}" value="{{ $archive->description ?? '' }}"
                                       class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select id="isFolder" name="isFolder" autocomplete="{{old('isFolder')}}"
                                    ...
                                    <option {{ !$archive->isFolder ? 'selected' : ''}} value="false">No</option>
                                    <option {{ $archive->isFolder ? 'selected' : ''}} value="true">Yes</option>
                                </select>
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select id="public" name="public" autocomplete="{{old('public')}}"
                                        class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    <option {{ !$archive->public ? 'selected' : ''}} value="false">No</option>
                                    <option {{ $archive->public ? 'selected' : ''}} value="true">Yes</option>
                                </select>
                            </div>
                        </div>
                    </div>
